...
public class EmployeeDetails1 {
	...
	public static void main(String[] args) {
			...
			public void run() {
				try {
					EmployeeDetails1 window = new EmployeeDetails1();
	...
	private void initialize() {
		...
		JCheckBox cb = new JCheckBox("mark attendance");
		cb.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		cb.setBounds(32, 143, 132, 23);
		...
		JLabel lblNewLabel_5 = new JLabel("Tharun Teja");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel_5.setBounds(74, 51, 90, 14);
		frame.getContentPane().add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("student");
